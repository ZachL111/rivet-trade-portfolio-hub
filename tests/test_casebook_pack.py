"""Regression checks for the rivet-trade-portfolio-hub casebook."""
...
from casebook.harness import assert_expected, rivet_trade_portfolio_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rivet_trade_portfolio_hub_summary(), assert_expected())
