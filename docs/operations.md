...
`rivet-trade-portfolio-hub` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for portfolio systems, covering visual model generation, layout fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 177. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 5.
